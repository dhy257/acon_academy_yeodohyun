...
public class AcornStudent_이현겸 {
	  ...
	  public void  입력하기( String name, int 에너지, int 근육량, int 자바능력, int 프론트능력, int 키){
	           this.name  = name;
	           this.에너지 = 에너지;
	           this.근육량 = 근육량;
	           this.자바능력 =  자바능력;
	...
	//정보 출력하기
	  ...
	  public void 자신감수치구하기() {
		  int conf = (this.근육량 * this.키 * this.에너지) / 1000;
		  System.out.println(this.name + " 자신감 수치: " + conf);
	  }
