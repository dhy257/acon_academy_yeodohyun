...
public class AcornStudent정철진 {
	  ...
	  public void  입력하기( String name, int 에너지, int 근육량, int 자바능력, int 프론트능력, int 멘탈){
	           this.name  = name;
	           this.에너지 = 에너지;
	           this.근육량 = 근육량;
	           this.자바능력 =  자바능력;
	...
	//정보 출력하기
	  ...
	  public void 주말휴식() {
			에너지 += 50;
			멘탈 += 50;
			System.out.println("푹 쉬어서 에너지가 " + 에너지 + ", 멘탈이 " + 멘탈 + "이 되었습니다.");
		}
